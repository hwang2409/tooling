//! A 900-instance field rendered through one mesh submission.

use chimy2::demo::{DemoArgs, build_culling_instancing_scene, render_instancing_scene, run_demo};
...
fn main() -> Result<(), Box<dyn Error>> {
    ...
    let scene = build_culling_instancing_scene(width as f32 / height as f32);
    run_demo(
