...
The four probes use isolated MuJoCo 3.11.0 models with one dynamic body and
`mj_forward`. Their executable provenance is
...
after conversion to newt's B-into-A convention. Newt values are from
`analytic_convex_route_probes_are_stable_against_default_oracle_cases`.
